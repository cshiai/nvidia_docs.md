# 4\. Binary Format[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#binary-format "Link to this heading")
...
The encoding of individual operations is described in [Operations](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/operations.html#section-operations).

## 4.1. Primitives[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#primitives "Link to this heading")
...
### 4.1.1. Fixed-Width Integers[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#fixed-width-integers "Link to this heading")
...
### 4.1.2. Variable-Width Integers[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#variable-width-integers "Link to this heading")
...
## 4.2. File Structure[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#file-structure "Link to this heading")
...
### 4.2.1. Magic Number[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#magic-number "Link to this heading")
...
### 4.2.2. Version[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#version "Link to this heading")
...
version {
  major: uint8\_t,    // Major version number
  minor: uint8\_t,    // Minor version number
  tag: uint16\_t      // Version tag (little-endian)
}
...
#### Version Compatibility Guarantees[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#version-compatibility-guarantees "Link to this heading")
...
### 4.2.3. Sections[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#sections "Link to this heading")
...
#### Deserialization[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#deserialization "Link to this heading")
...
#### String Section[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#string-section "Link to this heading")
...
#### Function Table Section[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#function-table-section "Link to this heading")
...
#### Constant Data Section[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#constant-data-section "Link to this heading")
...
constant {
  numConstants: varint,
  constantStartIndex: uint64\_t\[\],
  constantData: byte\[\]
}

Copy to clipboard

#### Type Section[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#type-section "Link to this heading")
...
type {
  numTypes: varint
  typeStartIndex: uint32\_t\[\] // array of offsets, length = numTypes
...
#### Detailed Type Encodings[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#detailed-type-encodings "Link to this heading")
...
shape : int64\_t\[\]          // Shape dimensions (var-length array)
...
elementTypeIndex : varint  // Index of the element type
shape : int64\_t\[\]          // Shape dimensions (var-length array)
strides : int64\_t\[\]        // Stride values (var-length array)
...
tileShape : int32\_t\[\]        // Tile shape (var-length array)
tensorViewTypeIndex : varint // Index of the TensorView type
dimMap : int32\_t\[\]           // Dimension mapping (var-length array)
...
#### Attribute Encoding[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#attribute-encoding "Link to this heading")
...
every : signed\_varint?        // Present if Bit 1 set
along : signed\_varint?        // Present if Bit 2 set
...
values : int64\_t\[\]          // Array of int64 values (var-length)
...
#### Global Section[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#global-section "Link to this heading")
...
#### Debug Section[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#debug-section "Link to this heading")

The debug section stores the serialized debug information (for more details about debug information see [Debug Info](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/debug_info.html#section-debug-info)). This section is optional as certain tools may ignore it and serializers may leave it empty for release builds.

debug {
  diOpsNum: varint          // Total number of operations with debug info
  padding: bytes            // Align to 4 bytes
  diIndexOffsets: uint32\_t\[\] // Per op offset into the debug info indices
  diIndicesNum: varint      // Total number of debug info indices
  padding: bytes            // Align to 4 bytes
  diIndices: uint64\_t\[\]     // Array of debug indices to debug info attributes
  diAttrNum: varint         // Total number of debug info attributes
  padding: bytes            // Align to 4 bytes
  diOffsets: uint32\_t\[\]     // Per debug info attribute offset into the debug info data
...
#### Debug Entry Payload Formats[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#debug-entry-payload-formats "Link to this heading")
...
## 4.3. Operation Opcodes and Encodings[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#operation-opcodes-and-encodings "Link to this heading")
...
## 4.4. Operation Encoding Details[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#operation-encoding-details "Link to this heading")
...
attributes : encoded\_attr\[\]       // Operation-specific attributes
operands : operand\_encoding       // Operation-specific operand encoding
regions : region\_encoding\[\]?      // Present for operations with regions
...
group1 : optional\_operand\_group
group2 : optional\_operand\_group
...
...
## 4.5. Section Ordering[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#section-ordering "Link to this heading")
