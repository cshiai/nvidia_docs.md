# 1\. Introduction[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/introduction.html#introduction "Link to this heading")
...
## 1.1. Scalable Data Parallel Computing with Tiles on GPU[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/introduction.html#scalable-data-parallel-computing-with-tiles-on-gpu "Link to this heading")
...
## 1.2. Goals and Scope[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/introduction.html#goals-and-scope "Link to this heading")
...
## 1.3. Document Structure[#](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/introduction.html#document-structure "Link to this heading")

1.  [Introduction](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/introduction.html#section-introduction) this section.
2.  [Programming Model](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/prog_model.html#section-prog-model) describes the programming model of **Tile IR**.
3.  [Syntax](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/syntax.html#section-syntax) defines the syntax of **Tile IR** programs used throughout the specification.
4.  [Binary Format](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/bytecode.html#section-bytecode) describes the **Tile IR** byte code and its binary format.
5.  [Type System](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/types.html#section-types) defines the type system of **Tile IR**.
6.  [Semantics](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/semantics.html#section-semantics) describes the semi-formal semantics of **Tile IR**.
7.  [Memory Model](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/memory_model.html#section-memory-model) describes the **Tile IR** memory model.
8.  [Operations](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/operations.html#section-operations) a listing of the full set of **Tile IR** operations.
9.  [Debug Info](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/debug_info.html#section-debug-info) describes the debug information format for **Tile IR** programs.
10.  [Stability](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/stability.html#section-stability) describes the stability guarantees of the **Tile IR**.
11.  [Appendix](https://docs.nvidia.com/cuda/tile-ir/13.2/sections/appendix.html#section-appendix) contains relevant reference materials, including full programs and references.
