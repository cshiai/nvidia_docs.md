...
size_t  CUDA_MEM_ALLOC_NODE_PARAMS_v2::accessDescCount [inherited]
in: number of memory access descriptors. Must not exceed the number of GPUs.

const

                              CUmemAccessDesc
                              * CUDA_MEM_ALLOC_NODE_PARAMS_v2::accessDescs [inherited]
in: array of memory access descriptors. Used to describe peer GPU access

size_t  CUDA_MEM_ALLOC_NODE_PARAMS_v2::bytesize [inherited]
in: size in bytes of the requested allocation

CUdeviceptrCUDA_MEM_ALLOC_NODE_PARAMS_v2::dptr [inherited]
out: address of the allocation returned by CUDA

struct CUmemPoolPropsCUDA_MEM_ALLOC_NODE_PARAMS_v2::poolProps [inherited]
