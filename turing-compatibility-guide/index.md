# 1. Turing Compatibility — Turing Compatibility Guide 13.1 documentation
...
CUDA applications built using CUDA Toolkit 9.x are compatible with Turing as long as they are built to include kernels in either Volta-native cubin format (see [Compatibility between Volta and Turing](index.html#turing-volta-compatibility)) or PTX format (see [Applications Using CUDA Toolkit 8.0 or Earlier](index.html#verifying-turing-compatibility-using-cuda-8-0)) or both.


### 1.4.3. Applications Using CUDA Toolkit 10.0


CUDA applications built using CUDA Toolkit 10.0 are compatible with Turing as long as they are built to include kernels in Volta-native or Turing-native cubin format (see [Compatibility between Volta and Turing](index.html#turing-volta-compatibility)), or PTX format (see [Applications Using CUDA Toolkit 8.0 or Earlier](index.html#verifying-turing-compatibility-using-cuda-8-0)), or both.
