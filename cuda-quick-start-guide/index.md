# CUDA Quick Start Guide — Quick Start Guide 13.1 documentation
...
Perform the following steps to install CUDA and verify the installation.
 ...
 ![_images/navigate_nbody.png](_images/navigate_nbody.png)
 9. Open the Build menu within Visual Studio and click Build Solution.

 ![_images/nbody_build.png](_images/nbody_build.png)
