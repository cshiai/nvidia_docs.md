# 1. Introduction — NVBLAS 13.1 documentation
...
### 7.2.6. [NVBLAS_GPU_DISABLED_<BLAS_FUNC_NAME>](index.html#nvblas_gpu_disabled)
...
### 7.2.7. [NVBLAS_CPU_RATIO_<BLAS_FUNC_NAME>](index.html#nvblas_cpu_ratio)
