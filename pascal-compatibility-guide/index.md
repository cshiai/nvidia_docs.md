# 1. Pascal Compatibility — Pascal Compatibility Guide 13.1 documentation
...
CUDA applications built using CUDA Toolkit 8.0 are compatible with Pascal as long as they are built to include kernels in either Pascal-native cubin format (see [Building Applications with Pascal Support](index.html#building-applications-with-pascal-support)) or PTX format (see [Applications Using CUDA Toolkit 7.5 or Earlier](index.html#verifying-pascal-compatibility-using-cuda-7-5)) or both.
