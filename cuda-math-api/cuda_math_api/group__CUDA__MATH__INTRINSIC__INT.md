...
All of these functions are supported in device code. For some of the functions, host-specific implementations are also provided. For example, see `[__nv_bswap16()](group__CUDA__MATH__INTRINSIC__INT.html#group__cuda__math__intrinsic__int_1ga4641c0ff23b709195539777c655f8f68)`. To use these functions, you do not need to include any additional header file in your program.
