...
C++ struct for handling fp4 data type of e2m1 kind.C++ struct for handling vector type of four fp4 values of e2m1 kind.C++ struct for handling vector type of two fp4 values of e2m1 kind.FP4 Conversion and Data Movement
To use these functions, include the header file cuda_fp4.h in your program.