...
C++ struct for handling fp8 data type of e4m3 kind.C++ struct for handling fp8 data type of e5m2 kind.C++ struct for handling vector type of four fp8 values of e4m3 kind.C++ struct for handling vector type of four fp8 values of e5m2 kind.C++ struct for handling vector type of four scale factors of e8m0 kind.C++ struct for handling vector type of two fp8 values of e4m3 kind.C++ struct for handling vector type of two fp8 values of e5m2 kind.C++ struct for handling vector type of two scale factors of e8m0 kind.FP8 Conversion and Data Movement
