# 1. Volta Compatibility — Volta Compatibility Guide 13.1 documentation
...
CUDA applications built using CUDA Toolkit 9.0 are compatible with Volta as long as they are built to include kernels in either Volta-native cubin format (see [Building Applications with Volta Support](index.html#building-applications-with-volta-support)) or PTX format (see [Applications Using CUDA Toolkit 8.0 or Earlier](index.html#verifying-volta-compatibility-using-cuda-8-0)) or both.
