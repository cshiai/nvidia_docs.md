...
| --- | --- | --- | --- |
| CUDA C++ Core Compute Libraries | Thrust | 3.1.2 | x86_64, arm64-sbsa |
| CUB | 3.1.2 |  |  |
| libcu++ | 3.1.2 |  |  |
...
| nvidia_fs1 | 2.27.3 | x86_64, arm64-sbsa | Linux |
...
| CUDA 13.0 Update 1 | >=580.82.07 |
| CUDA 13.0 GA | >=580.65.06 |
| CUDA 12.9 Update 1 | >=575.57.08 |
| CUDA 12.9 GA | >=575.51.03 |
| CUDA 12.8 Update 1 | >=570.124.06 |
| CUDA 12.8 GA | >=570.26 |
| CUDA 12.6 Update 3 | >=560.35.05 |
...
| CUDA 12.2 Update 2 | >=535.104.05 |
| CUDA 12.2 Update 1 | >=535.86.09 |
| CUDA 12.2 GA | >=535.54.03 |
